...
public class ManualInquiryFutureDateCancel extends Base{
	
	public ManualInquiryFutureDateCancel(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestManualInquiryFutureDateCancel() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from ManualInquiryFuturedate where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForManualInquiryCancelSampleScheduleRequest(hm);
