...
public class SelfServiceInquiryFutureDateEditUpdate extends Base{
	
	public SelfServiceInquiryFutureDateEditUpdate(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestSelfServiceInquiryFutureDateEditUpdate() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from SelfServiceInquiryFutureEdit where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForSelfServiceInquiryEditSampleScheduleRequest(hm);
