...
public class ClaimFutureDateEditUpdate extends Base{
	
	public ClaimFutureDateEditUpdate(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestClaimFutureDateEditUpdate() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from ClaimFutureEdit where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForClaimEditSampleScheduleRequest(hm);
