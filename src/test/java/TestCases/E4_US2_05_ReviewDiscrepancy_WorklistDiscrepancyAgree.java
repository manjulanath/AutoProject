...
public class E4_US2_05_ReviewDiscrepancy_WorklistDiscrepancyAgree extends Base{
	
	public E4_US2_05_ReviewDiscrepancy_WorklistDiscrepancyAgree(){
		super();
	}
	
  @Test
  public void iAuditE4_US2_05_ReviewDiscrepancy_WorklistDiscrepancyAgree() throws Exception {
	 ...
	 // MyWork mywork = new MyWork();
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US2_05 where TestName='"+testName+"'");
