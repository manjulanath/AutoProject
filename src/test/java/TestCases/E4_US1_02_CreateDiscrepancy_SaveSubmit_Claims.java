...
public class E4_US1_02_CreateDiscrepancy_SaveSubmit_Claims extends Base{
	
	public E4_US1_02_CreateDiscrepancy_SaveSubmit_Claims(){
		super();
	}
	
  @Test
  public void iAuditE4_US1_02_CreateDiscrepancy_SaveSubmit_Claims() throws Exception {
	 ...
	 // SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US1_02 where TestName='"+testName+"'");
		...
		//clicking Sample Schedule Request link
		  ...
		  constants.test.log(LogStatus.PASS, "Audit case is identified for Claim and selected and proceed to next page");
		  ...
		  mywork.dataEntryForUpdateSaveAndSubmitAuditCaseCLAIM(hm);
