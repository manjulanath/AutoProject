...
public class SelfServiceInquiry extends Base{
	
	public SelfServiceInquiry(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestSelfServiceInquiry() throws Exception {
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from SelfServiceInquiry where TestName='"+testName+"'");
...
*/
		  ...
		  sampleScheduleRequest.dataEntryForSelfServiceInquirySampleScheduleRequest(hm);
