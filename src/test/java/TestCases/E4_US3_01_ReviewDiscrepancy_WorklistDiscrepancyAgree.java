...
public class E4_US3_01_ReviewDiscrepancy_WorklistDiscrepancyAgree extends Base{
	
	public E4_US3_01_ReviewDiscrepancy_WorklistDiscrepancyAgree(){
		super();
	}
	
  @Test
  public void iAuditE4_US3_01_ReviewDiscrepancy_WorklistDiscrepancyAgree() throws Exception {
	 ...
	 // MyWork mywork = new MyWork();
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US3_01 where TestName='"+testName+"'");
		  
		  home=login.iAuditApplicationLogin(configData.getProperty("MTMErrorApproverLoginID"), configData.getProperty("MTMErrorApproverLoginPassword"));
		  ...
		  //approve case
		  myteam.approvecase(hm);
		  constants.test.log(LogStatus.PASS, "Approval is completed");
		  /*
		  //log off
		  home.logoff();
		  ...
		  //login again
		  home=login.iAuditApplicationLogin(configData.getProperty("MTMErrorApproverLoginID"), configData.getProperty("MTMErrorApproverLoginPassword"));
		  constants.test.log(LogStatus.PASS, "Log in with error approver credential");
		...
		//validate links in My team page
		  ...
		  //Select case 
		  myteam.dataEntryForSelectingCase(hm);
		  constants.test.log(LogStatus.PASS, "Case is present in workbasket");
		  */
