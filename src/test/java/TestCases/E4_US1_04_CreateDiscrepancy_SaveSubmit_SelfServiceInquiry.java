...
public class E4_US1_04_CreateDiscrepancy_SaveSubmit_SelfServiceInquiry extends Base{
	
	public E4_US1_04_CreateDiscrepancy_SaveSubmit_SelfServiceInquiry(){
		super();
	}
	
  @Test
  public void iAuditE4_US1_04_CreateDiscrepancy_SaveSubmit_SelfServiceInquiry() throws Exception {
	 ...
	 // SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US1_04 where TestName='"+testName+"'");
		...
		//clicking Sample Schedule Request link
		  ...
		  constants.test.log(LogStatus.PASS, "Audit case is identified for Self Service Inquiry and selected and proceed to next page");
		  ...
		  mywork.dataEntryForUpdateSaveAndSubmitAuditCaseSelfServiceInquiry(hm);
