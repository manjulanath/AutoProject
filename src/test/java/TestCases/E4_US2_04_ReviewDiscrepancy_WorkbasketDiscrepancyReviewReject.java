...
public class E4_US2_04_ReviewDiscrepancy_WorkbasketDiscrepancyReviewReject extends Base{
	
	public E4_US2_04_ReviewDiscrepancy_WorkbasketDiscrepancyReviewReject(){
		super();
	}
	
  @Test
  public void iAuditE4_US2_04_ReviewDiscrepancy_WorkbasketDiscrepancyReviewReject() throws Exception {
	 ...
	 // MyWork mywork = new MyWork();
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US2_04 where TestName='"+testName+"'");
