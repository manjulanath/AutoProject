...
public class ClaimFutureDateCancel extends Base{
	
	public ClaimFutureDateCancel(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestClaimFutureDateCancel() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from ClaimFuturedate where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForClaimCancelSampleScheduleRequest(hm);
