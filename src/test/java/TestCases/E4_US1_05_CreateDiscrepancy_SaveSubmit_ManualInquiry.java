...
public class E4_US1_05_CreateDiscrepancy_SaveSubmit_ManualInquiry extends Base{
	
	public E4_US1_05_CreateDiscrepancy_SaveSubmit_ManualInquiry(){
		super();
	}
	
  @Test
  public void iAuditE4_US1_05_CreateDiscrepancy_SaveSubmit_ManualInquiry() throws Exception {
	 ...
	 // SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US1_05 where TestName='"+testName+"'");
		...
		//clicking Sample Schedule Request link
		  ...
		  mywork.dataEntryForUpdateSaveAndSubmitAuditCaseManualInquiry(hm);
