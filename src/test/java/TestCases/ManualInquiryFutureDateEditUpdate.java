...
public class ManualInquiryFutureDateEditUpdate extends Base{
	
	public ManualInquiryFutureDateEditUpdate(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestManualInquiryFutureDateEditUpdate() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from ManualInquiryFutureEdit where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForManualInquiryEditSampleScheduleRequest(hm);
