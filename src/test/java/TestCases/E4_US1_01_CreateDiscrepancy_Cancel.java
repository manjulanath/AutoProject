...
public class E4_US1_01_CreateDiscrepancy_Cancel extends Base{
	
	public E4_US1_01_CreateDiscrepancy_Cancel(){
		super();
	}
	
  @Test
  public void iAuditE4_US1_01_CreateDiscrepancy_Cancel() throws Exception {
	 ...
	 // SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from E4_US1_01 where TestName='"+testName+"'");
		...
		//clicking Sample Schedule Request link
		  ...
		  constants.test.log(LogStatus.PASS, "Audit case is identified and selected and proceed to next page");
		  ...
		  constants.test.log(LogStatus.PASS, "Create discrepancy is clicked and sections are validated");
		  
		  mywork.cancelCreateDiscrepancy(hm);
		  constants.test.log(LogStatus.PASS, "Cancel is working as expected");
