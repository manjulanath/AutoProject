...
public class EnrollmentFutureDateEditUpdate extends Base{
	
	public EnrollmentFutureDateEditUpdate(){
		super();
	}
	
  @Test
  public void iAuditSampleScheduleRequestEnrollmentFutureDateEditUpdate() throws Exception {
...
//	  SampleScheduleRequest sampleScheduleRequest = new SampleScheduleRequest();	
	  ...
	  try{
		  ...
		  HashMap<String, String> hm=lib.GetDataFromExcel(constants.testDataPath+"\\\\"+configData.getProperty("TestDataExcelFileName"),
				  "Select * from EnrollmentFutureEdit where TestName='"+testName+"'");
		  ...
		  ssr.dataEntryForEnrollmentEditSampleScheduleRequest(hm);
